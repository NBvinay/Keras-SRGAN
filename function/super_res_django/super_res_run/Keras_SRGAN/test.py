...
import super_res_run.Keras_SRGAN.Utils, super_res_run.Keras_SRGAN.Utils_model
from super_res_run.Keras_SRGAN.Utils_model import VGG_LOSS
...
if __name__== "__main__":
    ...
    parser.add_argument('-ihr', '--input_hig_res', action='store', dest='input_hig_res', default='F:/wamp/www/super-res/Keras-SRGAN/data_hr/' ,
                    help='Path for input images Hig resolution')
                    
    parser.add_argument('-ilr', '--input_low_res', action='store', dest='input_low_res', default='F:/wamp/www/super-res/Keras-SRGAN/data_lr/' ,
                    help='Path for input images Low resolution')
                    
    parser.add_argument('-o', '--output_dir', action='store', dest='output_dir', default='F:/wamp/www/super-res/Keras-SRGAN/output/' ,
                    help='Path for Output images')
    
    parser.add_argument('-m', '--model_dir', action='store', dest='model_dir', default='F:/wamp/www/super-res/Keras-SRGAN/model/gen_model3000.h5' ,
                    help='Path for model')
